...
@Component
public class VentanaMuestraReportes extends JFrame {
	...
	public VentanaMuestraReportes() {
		...
		btnRegresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlMuestraReportes.iniciaVentanaReporteEmpleados(empleado);
				oculta();
			}
		});
		...
		modeloReportes.addColumn("Empleado Reportado");
	...
	public void llenaTabla(ReporteEmpleados reporte) {
		...
		a[4] = reporte.getEmpleado().getNombre() + " " + reporte.getEmpleado().getApellido();
